...
{
    public interface IQueryContext : ICanGetService, ICanGetModel, ICanGetSystem, ICanSendQuery
    {
    ...
    /// </summary>
    public abstract partial class AbstractQuery<TResult> : IQuery<TResult>
    {
